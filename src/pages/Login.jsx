...
function Login() {
    ...
    return (
    <div className="grid md:grid-cols-2 bg-[#322C2B] md:py-12 md:px-20 p-0 min-h-dvh ">
        <div className="h-full rounded-l-sm bg-[#E4C59E]">
        <div className="bg-beige-500 md:flex items-center justify-center">
            <img src={LoginImg} alt="Fashion Image" className="md:mt-10 md:w-[500px] md:h-[550px] object-cover rounded-lg" />
        </div>
        </div>
        <div className=" bg-white shadow-md rounded-r-sm grid ">
        <div className="md:ms-20 mt-12 md:w-3/4 p-8 w-full">
